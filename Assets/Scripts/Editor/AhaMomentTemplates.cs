...
namespace BearCar.Editor
{
    ...
    public static class AhaTemplates
    {
        ...
        public static AhaTemplate HiddenCombo = new AhaTemplate
        {
            ...
            emoji = "🧪",
            category = AhaCategory.Discovery,
            description = "曼妥思和可乐分开只是普通道具。绿熊选中一个，红熊选中另一个，同时按使用键触发超级火箭推进！",
            ahaHint = "你选曼妥思，我选可乐，一起按！",
            difficulty = "困难",
            designRationale = "隐藏的道具组合需要双人配合才能触发。绿熊和红熊各自选中组合的一部分，同时按Tab和/键触发。这是最强的同步型Aha体验！",
            CreateInScene = (basePos) =>
            {
